...
public class Person {
    ...
    /**
     * This constructor will contain all the information that a person holds
     ...
     * @param fatherID father id parameter
     * @param motherID mother id parameter
     * @param spouseID spouse id parameter
     */
